...
tape( 'if provided a `max_iter` option which is not a number primitive, the function returns a type error', function test( t ) {
	var values;
	var err;
	var i;
...
tape( 'if provided a `keep` option which is not a boolean primitive, the function returns a type error', function test( t ) {
	var values;
	var err;
	var i;
