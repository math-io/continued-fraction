...
/**
* NOTE: the original C++ code and copyright notice is from the [Boost library]{http://www.boost.org/doc/libs/1_43_0/boost/math/tools/fraction.hpp}.
*
...
/**
* FUNCTION: continued_fraction_a( generator, factor, max_iter )
*	Evaluates
*           a1
*      ---------------
*      b1 +     a2
...
*/
function continued_fraction_a( gen, factor, max_iter ) {
